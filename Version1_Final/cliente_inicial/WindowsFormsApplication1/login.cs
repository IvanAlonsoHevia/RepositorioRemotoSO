...
namespace WindowsFormsApplication1
{
    public partial class login : Form
    {
        ...
        List<Puntuacion> formulariosPuntuacion = new List<Puntuacion>();
        ...
        public delegate void SetLabelTextCallback(int i,Label l);
        ...
        public void ThreadPuntuacion(int ID, string mensajerecibido)
        {
            ThreadStart tx = delegate { EnviarJugada3(ID, mensajerecibido); };
            Thread form2 = new Thread(tx);
            form2.Start();
        }
        ...
        public void EnviarJugada3(int ID, string mensajerecibido)
        {
            ...
            for (i = 0; i <= contFormsPartida; i++) 
            {
                formulariosPartida[i].RecibirJugada3(ID);
            }


             contFormsPuntuacion = formulariosPuntuacion.Count;
             FormPuntuacion = new Puntuacion(ID, server); //Pasamos el socket, el ID y el username como constructores al Form de la partida al recibir el código 11.
             formulariosPuntuacion.Add(FormPuntuacion);
             formulariosPuntuacion[contFormsPuntuacion].MostrarPuntuaciones(mensajerecibido);
             FormPuntuacion.ShowDialog();
        ...
        private void AtenderServidor()
        {
            while (true)
            {
                ...
                int codigo;
                string mensaje = ""; string mensaje2;
                if (mensajerecibido != "")
                {
                ...
                switch (codigo)
                {
                    ...
                    case 17:
                        ...
                        DelegadoPartida3 delegadopartida3 = new DelegadoPartida3(ThreadPuntuacion);
                        this.Invoke(delegadopartida3, new object[] {Convert.ToInt32(mensaje), mensajerecibido});
                        break;
